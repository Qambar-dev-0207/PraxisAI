  ...
  return (
    <main className="min-h-screen w-full relative flex items-center justify-center overflow-hidden bg-white text-black font-sans selection:bg-lime-400 selection:text-white">
      ...
      <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-0 z-10 border-x border-black/10 min-h-screen lg:min-h-0 lg:h-[600px]">
        ...
        <div className="lg:col-span-7 relative p-8 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-black/10 bg-white/50 backdrop-blur-sm">
             {/* Technical Markers */}
             ...
             >
                 ...
                 <h1 className="text-8xl md:text-9xl font-display font-bold uppercase tracking-tighter leading-[0.85] text-black mix-blend-darken">
                     Praxis
                     <span className="block text-transparent stroke-text">AI</span>
                 </h1>
             </motion.div>
             ...
             >
                 ...
                 <div className="flex items-center gap-8 pt-8 border-t border-black/10">
                    <div>
                        <span className="block font-mono text-[10px] text-black/40 uppercase tracking-widest">Latency</span>
                        <span className="font-display text-xl">12<span className="text-sm">ms</span></span>
                    </div>
                    <div>
                ...
                <form action={dispatch} className="space-y-5">
                    ...
                    {errorMessage && (
                        <div className="p-4 bg-red-500/10 border border-red-500/20 flex items-center gap-3">
                            ...
                            <p className="font-mono text-xs text-red-600">{errorMessage}</p>
                        </div>
                    )}
